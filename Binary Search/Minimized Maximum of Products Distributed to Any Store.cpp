...
After distribution, each store will be given some number of products (possibly 0). Let x represent the maximum number of products given to any store.
...
class Solution {
public:
    bool can(int cand, vector<int> &quantities, int n)
    {
        int ans = 0;
