...
// Good question
// REF : https://leetcode.com/problems/maximum-performance-of-a-team/discuss/1252412/C%2B%2BJavaPython-MinHeap-Solution-Clean-and-Concise
...
public:
    int maxPerformance(int n, vector<int>& speed, vector<int>& efficiency, int k) 
    {
        ...
        sort(eng.rbegin(), eng.rend()); // Sort by decreasing order of efficiency
        ...
        for(auto& [e, s] : eng)
        {
            ...
            if(pq.size() > k)
                speedSum -= pq.top(), pq.pop(); // Over k engineers -> remove the lowest speed engineer
            
            ans = max(ans, (long long)e * speedSum);
        }
