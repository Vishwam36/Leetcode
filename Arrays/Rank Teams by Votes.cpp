...
to resolve the conflict, if they tie again, we continue this process until the ties are resolved. If two or more teams are still tied after considering all 
...
public:
    string rankTeams(vector<string>& votes) 
    {
        ...
        string ans = votes[0];
        // tricky comparator
        sort(ans.begin(), ans.end(), [&freq](auto &c1, auto &c2){
