...
// REF : https://www.youtube.com/watch?v=ld_W5tvJJsk
    ...
    string countOfAtoms(string formula)
    {
        ...
        while(i < n)
        {
            ...
            else if(formula[i] == ')')
            {
                ...
                map<string, int> curr = s.top(); s.pop();
            ...
            else
            {
                ...
                while(i < n && isSmallChar(formula[i]))
                    atom.push_back(formula[i++]);
